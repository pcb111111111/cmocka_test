...
function(make_deb_target COMPONENT)
    ...
    if( NOT DEB_PACKAGE${COMPONENT}_VERSION )
        message(FATAL_ERROR "Not set package version 'DEB_PACKAGE${COMPONENT}_VERSION'")
    endif()
    ...
    if( NOT DEB_PACKAGE${COMPONENT}_MAINTAINER )
        message(FATAL_ERROR "Not set package maintainer 'DEB_PACKAGE${COMPONENT}_MAINTAINER'")
    endif()
